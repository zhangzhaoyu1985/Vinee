...
public class NewsFeedData implements org.apache.thrift.TBase<NewsFeedData, NewsFeedData._Fields>, java.io.Serializable, Cloneable, Comparable<NewsFeedData> {
  ...
  private static final org.apache.thrift.protocol.TField BOTTLE_INFO_FIELD_DESC = new org.apache.thrift.protocol.TField("bottleInfo", org.apache.thrift.protocol.TType.STRUCT, (short)10);
  ...
  public BottleInfo bottleInfo; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    BOTTLE_INFO((short)10, "bottleInfo"),
  ...
  static {
    ...
    tmpMap.put(_Fields.AUTHOR_URL, new org.apache.thrift.meta_data.FieldMetaData("authorUrl", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.BOTTLE_INFO, new org.apache.thrift.meta_data.FieldMetaData("bottleInfo", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public NewsFeedData(NewsFeedData other) {
    ...
    if (other.isSetBottleInfo()) {
      this.bottleInfo = new BottleInfo(other.bottleInfo);
    }
  ...
  public NewsFeedData setBottleInfo(BottleInfo bottleInfo) {
    this.bottleInfo = bottleInfo;
    return this;
  }

  public void unsetBottleInfo() {
    this.bottleInfo = null;
  }

  /** Returns true if field bottleInfo is set (has been assigned a value) and false otherwise */
  public boolean isSetBottleInfo() {
    return this.bottleInfo != null;
  }

  public void setBottleInfoIsSet(boolean value) {
    if (!value) {
      this.bottleInfo = null;
    }
  }
  ...
  public NewsFeedData setUserid(int userid) {
    this.userid = userid;
    setUseridIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BOTTLE_INFO:
      if (value == null) {
        ...
        setBottleInfo((BottleInfo)value);
      }
      break;
  ...
  public boolean equals(NewsFeedData that) {
    ...
    boolean this_present_bottleInfo = true && this.isSetBottleInfo();
    boolean that_present_bottleInfo = true && that.isSetBottleInfo();
    if (this_present_bottleInfo || that_present_bottleInfo) {
      if (!(this_present_bottleInfo && that_present_bottleInfo))
        return false;
      if (!this.bottleInfo.equals(that.bottleInfo))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_bottleInfo = true && (isSetBottleInfo());
    list.add(present_bottleInfo);
    if (present_bottleInfo)
      list.add(bottleInfo);
  ...
  public int compareTo(NewsFeedData other) {
    ...
    lastComparison = Boolean.valueOf(isSetBottleInfo()).compareTo(other.isSetBottleInfo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBottleInfo()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.bottleInfo, other.bottleInfo);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("bottleInfo:");
    if (this.bottleInfo == null) {
      sb.append("null");
    } else {
      sb.append(this.bottleInfo);
    }
    first = false;
    if (!first) sb.append(", ");
    sb.append("userid:");
  ...
  private static class NewsFeedDataStandardScheme extends StandardScheme<NewsFeedData> {
        ...
        switch (schemeField.id) {
          ...
          case 10: // BOTTLE_INFO
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.bottleInfo = new BottleInfo();
              struct.bottleInfo.read(iprot);
              struct.setBottleInfoIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, NewsFeedData struct) throws org.apache.thrift.TException {
      ...
      if (struct.bottleInfo != null) {
        oprot.writeFieldBegin(BOTTLE_INFO_FIELD_DESC);
        struct.bottleInfo.write(oprot);
        oprot.writeFieldEnd();
      }
